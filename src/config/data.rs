...
impl HiddenSettings {
    ...
    pub fn to_candy_format(&self) -> mpl_core_candy_machine_core::HiddenSettings {
        mpl_core_candy_machine_core::HiddenSettings {
...
// impl Creator {
//     pub fn to_candy_format(&self) -> Result<mpl_core_candy_machine_core::Creator> {
//         let creator = mpl_core_candy_machine_core::Creator {
